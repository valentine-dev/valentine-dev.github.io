...
- JavaScript (ES6+): React, Node.js, Bootstrap, jQuery
  - Sample: [React – JavaScript library for building user interfaces](./address-auto-complete) - [Source code](https://github.com/valentine-dev/real-time-stock-quotes)
  - Sample: [Node.js - JavaScript runtime built on Chrome's V8 JavaScript engine](./real-time-stock-quote) - [Source code](https://github.com/valentine-dev/real-time-stock-quotes)
...
- Frontend: React, jQuery, Bootstrap, JavaScript (ES6+) -> [Go to explore the AMS UI](./address-auto-complete)
- Backend: Java 8
